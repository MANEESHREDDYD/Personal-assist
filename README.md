...
- **Text-only** drafts in this phase. Attachments must be added manually inside Gmail/Outlook (provider attachment upload is planned for Phase 3I).
...
| 3H.1 | Lint repair + live OAuth verification + no-send compliance evidence | ✅ Current |
| 3I | Provider draft attachment upload after approval | 🔜 Next |
